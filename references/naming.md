...
6. Keep the extension conventional for the file type. The extension is not part of the one-word or hierarchical stem.
7. Preserve exact names required by a host, protocol, ecosystem, or repository contract, such as `SKILL.md`, `README.md`, or `openai.yaml`.
...
| Prefer | Avoid | Reason |
|---|---|---|
| `settings.py` | `resolve_settings.py` | One word is sufficient. |
