...
When the prerequisite is an agent skill, follow [install.md](../references/install.md) for discovery, canonical install, and same-scope verification.
...
- Prefer repository-native or host-native installers and initializers. For agent skills, see [install.md](../references/install.md).
